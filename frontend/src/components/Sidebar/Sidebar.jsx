...
const sidebar = memo(() => {
    ...
    return (
        <aside className="bg-[#18191A] flex flex-col gap-[1.35rem] w-[15.65rem] h-auto py-[3.15rem] px-2.5">
            ...
            <nav ref={menuRef} className="">
                <ul className="flex flex-col w-full h-auto gap-[0.95rem] px-[1.3rem] text-white">
